 ...
 * @author loqco
 */
public class TAPCHI_FORM1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("THÔNG TIN TẠP CHÍ");
        ...
        txtMaTapChi.setEnabled(false);

        txtTenTapChi.setEnabled(false);

        txtSoPH.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TAPCHI_FORM1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TAPCHI_FORM1().setVisible(true);
